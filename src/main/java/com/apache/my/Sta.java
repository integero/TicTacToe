...
//  game static object common for big & small fields
class Sta {
...
//  set of indexes of sequence array for all sells
    ...
    private static int bigDx;   //  distance between small game fields in big field
    static int XO;              //  current player sign   1 - X   -1 - 0
    static boolean finish;      //  flag of end of game
    static  Color[] bigCellClr; //  colors for denoting owners of small fields
...
//  never used but...
    ...
    Sta() {
        ...
        bigCellClr[0] = Color.LIGHTBLUE;    //  color for 0 owner
        bigCellClr[1] = Color.GOLD;         //  color for no owner
        bigCellClr[2] = Color.ORANGERED;    //  color for X owner
